...
| `COMPRESSATORIUM_DISABLE_AUTH` | `false` | Disable built-in auth only when another access-control layer protects the service. |
...
- Keep built-in auth enabled, and optionally add proxy authentication
